...
<?php $__env->startSection('content'); ?>
        <div id="product" data-token="<?php echo e($token); ?>" data-id="<?php echo e($product->id); ?>">
                            ...
                            <div class="product-details-img product-details-tab">
                                <div class="zoompro-wrap zoompro-2">
                                    <div class="zoompro-border zoompro-span">
                                        <img class="zoompro" :src="'/' + product.product_image_path" data-zoom-image="/<?php echo e($product->product_image_path); ?>" alt="" />
                                    </div>
                                </div>
                            ...
                            <div class="product-details-content">
                                ...
                                <div class="pro-details-color-wrap">
                                    ...
                                    <div class="product-size">
                                        <span>Size</span>
                                        <select name="size">
                                            <?php $__currentLoopData = $productSize; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productSizes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($productSizes->size_id); ?>"><?php echo e($size = \App\Models\Size::where('id',$productSizes->size_id)->value('name')); ?></option>
