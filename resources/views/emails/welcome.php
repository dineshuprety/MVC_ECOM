...
<html>
<head>
  <title>40plus Template</title>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css" rel="stylesheet">
  <link href="https://fonts.googleapis.com/css?family=Roboto:400,500,600" rel="stylesheet">
  <style>
   body{width:650px;font-family:work-Sans,sans-serif;background-color:#f6f7fb;display:block;margin:0 auto;padding-top:50px;}a{text-decoration:none}span{font-size:14px}p{font-size:13px;line-height:1.7;letter-spacing:.7px;margin-top:0}.text-center{text-align:center}h6{font-size:16px;margin:0 0 18px}.template-sosial{display:flex;align-items:center;justify-content:center}.template-sosial li{background-color:#eff1f2;width:35px;height:35px;border-radius:50%;display:flex;align-items:center;justify-content:center;margin-right:15px}.template-sosial li:last-child{margin-right:0}.template-sosial li:hover{background-color:#1c9dea}.template-sosial li:hover a{color:#fff}.template-sosial li a i{font-size:14px}ul.logo{display:flex;justify-content:center;padding-left:0}ul.logo li{width:40px;height:40px;border:1px solid #000;border-radius:50%;display:flex;align-items:center;justify-content:center;margin-right:10px}ul.logo li:last-child{margin-right:0}
  </style>
</head>
<body>
<table style="width: 650px; margin-bottom: 30px;">
  <tbody>
    <tr>
      <td><img src="../../../public/images/logo/logo-4.jpg" alt="logo"></td>
      <td style="text-align: right; color:#999"><span>E-commerce</span></td>
    </tr>
  </tbody> 
</table>
      ...
      <table border="0" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF;border-color:#E5E5E5; border-style:solid; border-width:0 1px 1px 1px;" width="100%">
        ...
        <tr>
          <td align="center" valign="top" style="padding-bottom:5px;padding-left:20px;padding-right:20px;">
            <h2 style="color:#000000; font-family:'Poppins', Helvetica, Arial, sans-serif; font-size:28px; font-weight:500; font-style:normal; letter-spacing:normal; line-height:36px; text-transform:none; text-align:center; padding:0; margin:0">Welcome</h2>
          </td>
        </tr>
        <tr>
          <td align="center" valign="top" style="padding-bottom:30px;padding-left:20px;padding-right:20px;">
            <h4 class="text" style="color:#999999; font-family:'Poppins', Helvetica, Arial, sans-serif; font-size:16px; font-weight:500; font-style:normal; letter-spacing:normal; line-height:24px; text-transform:none; text-align:center; padding:0; margin:0">Getting Started 40plustemplate Online Shop</h4>
          </td>
        </tr>
        <tr>
      ...
      <table class="footer" style="border:1px solid #E5E5E5; width:100% ; padding-bottom:30px;">
        ...
        <tr>
          <td align="center" valign="top" style="padding-top:10px;padding-bottom:5px;padding-left:10px;padding-right:10px;">
            <p class="text" style="color:#777777; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:12px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:20px; text-transform:none; text-align:center; padding:0; margin:0;">&copy;&nbsp; 40plustemplate. | Nepal | Jhapa Surunga 3.</p>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td align="center" valign="top" style="padding-top:0px;padding-bottom:10px;padding-left:10px;padding-right:10px;">
            <p class="text" style="color:#777777; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:12px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:20px; text-transform:none; text-align:center; padding:0; margin:0;">If you have any quetions please contact us <a href="#" style="color:#777777;text-decoration:underline;" target="_blank">support@mail.com.</a><br><a href="#" style="color:#777777;text-decoration:underline;" target="_blank">Unsubscribe</a> from our mailing lists</p>
          </td>
        </tr>
      </table>
    </td>
