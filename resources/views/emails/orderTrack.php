...
<html>
   ...
   <body>
      <table style="width: 650px; margin-bottom: 30px;">
         <tbody>
            <tr>
               <td><img src="http://shopifynepal.com/asstes/images/logo.png" alt="logo" height="80px" width="80px"></td>
