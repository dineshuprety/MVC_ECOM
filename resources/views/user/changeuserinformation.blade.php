                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" cols="30" rows="4" id="address" placeholder=" Enter Your  Address" name="address">
{{ (user()->address == null)? \App\Classes\Request::old('post', 'notes') : user()->address }}
                                </textarea>
                            </div>
                            <!-- // end form group  -->
                        </div>
