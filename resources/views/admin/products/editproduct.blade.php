         ...
         <div class="card m-b-30">
            <div class="card-body">
                  ...
                  <div class="col">
                     <div class="form-group">
                        ...
                        <select class="form-control" name="sub_category_id" id="product-subcategory" >
                           ...
                           @if(ucfirst($result['sub_category_id'])==$list->id)
                           <option selected value="{{$list->id}}">
                              @else
                           <option value="{{$list->id}}">
                              @endif
                  ...
                  <div class="col">
                     <div class="form-group">
                        ...
                        <select class="form-control" name="product_on" id="exampleFormControlSelect1" >
                            @if($result['producton']=='0')
                            <option selected value="0">new</option>
                            <option value="1">hot sales</option>
                            <option value="2">feature</option>
                            @elseif($result['producton'] =='1')
                            <option selected value="1">hot sales</option>
                            <option value="0">new</option>
                            <option value="2">feature</option>
                            @elseif($result['producton']=='2')
                            <option selected value="2">feature</option>
                            <option value="0">new</option>
                            <option value="1">hot sales</option>
                            @else
               ...
               <div class="form-group">
                  ...
                  <textarea class="form-control" id="summernote" name="description" rows="3" placeholder="write a description">
                  {{$result['description']}}
                  </textarea>
               </div>
            </div>
