@extends('admin.layout.base') @section('title', 'Wholesaler Users') @section('data-page-id', 'wholesalerusers') @section('content')
                                ...
                                <tr>
                                    ...
                                    <td class="c-table__cell">
                                        ...
                                        <span data-toggle="tooltip" data-placement="top" title="Aprove the user" style="display: inline-block;">
                                            <a href="/admin/users/wholesalers/{{$user['id']}}/updateStatus">
                                        ...
                                        <span data-toggle="tooltip" data-placement="top" title="Delete User" style="display: inline-block;" >
                                            <form method="POST" action="/admin/users/wholesalers/{{$user['id']}}/delete" class="delete-item">
